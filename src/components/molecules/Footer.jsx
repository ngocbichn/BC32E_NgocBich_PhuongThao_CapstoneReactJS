...
const Footer = () => {
  return (
    <Container className="Footer">
      <footer className="container py-6 dark:bg-gray-800 dark:text-gray-50">
        <div className="px-6 mx-auto space-y-6 divide-y divide-gray-400 md:space-y-12 divide-opacity-50">
          <div className="grid grid-cols-12">
            <div className="pb-6 col-span-full md:pb-0 md:col-span-3">
              ...
              >
                <span className="brand_name self-center text-5xl font-bold">
                  Cinema
                </span>
              </a>
            </div>
            ...
            <div className="col-span-6 text-center md:text-left md:col-span-3">
              <p className="list_title pb-1 text-lg font-semibold">Legal</p>
              <ul>
                <li className="footer_list">
                  <a
                    rel="noopener noreferrer"
            ...
            <div className="col-span-6 text-center md:text-left md:col-span-3">
              <p className="list_title pb-1 text-lg font-semibold">Contact</p>
              <ul>
                <li className="footer_list">
                  <a
                    rel="noopener noreferrer"
